    ...
    <section className='py-16 px-6 bg-[#F2F4F7]'>
      <div className="flex flex-col md:flex-row justify-between">
          <div className="w-full md:w-1/2 container px-1 md:px-5">
             ...
             <p className='text-sm my-10 font-semibold'>Thousand is a full-cycle digital production company with its own product analytics, <br /> design, web and mobile development.</p>
             ...
             <p className='text-sm my-10 font-semibold'>All the necessary specialists - from a designer to a tester - are on our staff. We hire <br /> the best specialists in the market. It's expensive but worth it</p>
          </div>
